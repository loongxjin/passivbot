    ...
    *,
    ...
    if backtest_params is None:
        ...
        backtest_params = {
            ...
            "day_drop_twe_threshold_pct": float(
                get_optional_config_value(config, "backtest.day_drop_twe_threshold_pct", 0.0) or 0.0
            ),
            "day_drop_twe_multiplier": float(
                get_optional_config_value(config, "backtest.day_drop_twe_multiplier", 0.0) or 0.0
            ),
        }
...
def post_process(
    ...
    bt_cfg.setdefault("day_drop_twe_threshold_pct", float(bt_cfg.get("day_drop_twe_threshold_pct", 0.0) or 0.0))
    bt_cfg.setdefault("day_drop_twe_multiplier", float(bt_cfg.get("day_drop_twe_multiplier", 0.0) or 0.0))
